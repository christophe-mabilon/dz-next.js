  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(to left, rgba(0, 0, 0, 0.4) 7%, rgba(0, 0, 0, 0.6) 50%, rgba(0, 0, 0, 0.4) 93%), url(/assets/img/header.avif)`,
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-primary-50">
              Maçonnerie générale, rénovation, extension et terrassement. Plus
              de 15 ans d'expertise au service de vos projets.
            </p>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Une gamme complète de services pour tous vos projets de
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-primary-100 rounded-2xl h-96 flex items-center justify-center">
              <p className="text-center text-primary-600 font-semibold">
                Image/vidéo de chantier
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="hero-gradient py-16 md:py-24 text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-primary-50 mb-8 max-w-2xl mx-auto">
            Contactez-nous pour un devis gratuit et sans engagement. Réponse
            garantie sous 24h.
          </p>
          <Link
            href="/contact"
