  ...
  return (
    <>
      ...
      <section className="hero-gradient relative overflow-hidden py-20 md:py-32 text-white">
        <div className="container-custom">
          ...
          <p className="text-xl text-primary-50 max-w-3xl">
            Découvrez la satisfaction de nos clients qui ont fait confiance à DZ Maçonnerie & Terrassement
          </p>
        </div>
      </section>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {stats.map((stat, idx) => (
              <div key={idx} className="text-center p-6 bg-gray-50 rounded-xl border border-gray-200 hover:border-primary-600 hover:bg-primary-50 transition-all">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1">
                <p className="text-gray-700 leading-relaxed">
                  Nos clients nous font confiance pour la qualité de notre travail, notre professionnalisme et notre écoute.
                  Chaque avis positif nous encourage à continuer à fournir un service d'excellence.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <h2 className="heading-md mb-12 text-center">Témoignages de nos clients</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {reviews.map((review, idx) => (
              <div key={idx} className="bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow border border-gray-200">
                {/* Stars */}
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  <p className="text-xs text-primary-600 font-medium mt-2">{review.service}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <h2 className="heading-md mb-12 text-center">Pourquoi nos clients nous choisissent</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="p-6 bg-gray-50 rounded-xl border border-gray-200 hover:border-primary-600 hover:bg-primary-50 transition-all">
      ...
      <section className="section-padding bg-primary-50">
        <div className="container-custom max-w-2xl text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Rejoignez les centaines de clients satisfaits qui ont fait confiance à DZ Maçonnerie & Terrassement.
