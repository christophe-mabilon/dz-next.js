        ...
        <div className="container-custom">
          <div className="max-w-3xl">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-primary-100">{city.zipCode} - {city.region}</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Maçonnerie à {city.name}
            </h1>
            <p className="text-xl text-primary-50">
              Services professionnels de maçonnerie générale, rénovation, extension et terrassement à {city.name}. Plus de 15 ans d'expertise au service de vos projets.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom max-w-3xl">
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              DZ Maçonnerie & Terrassement est votre partenaire de confiance pour tous vos projets de maçonnerie à {city.name} ({city.zipCode}).
              Basés à Artas, nous intervenons dans la région {city.region} avec une équipe de professionnels qualifiés et expérimentés.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              Depuis plus de 15 ans, nous réalisons des projets de construction, rénovation et extension pour des particuliers et des professionnels.
              Chaque chantier est suivi avec rigueur pour garantir votre satisfaction.
            </p>
          </div>

          {/* Services in this city */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-8">Services à {city.name}</h2>
            <p className="text-gray-600 mb-6">
              Nous proposons une gamme complète de services maçonnerie adaptés à vos besoins à {city.name}.
            </p>
          ...
          {/* Why Choose Us */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-8">Pourquoi nous choisir à {city.name} ?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="p-6 bg-gray-50 rounded-lg border border-gray-200 hover:border-primary-600 hover:bg-primary-50 transition-all">
          ...
          <div className="bg-primary-50 p-8 rounded-xl border border-primary-200 mb-12">
            ...
            <p className="text-gray-700 mb-4">
              Basés à Artas, nous intervenons à {city.name} et dans toute la région {city.region}.
            </p>
            <p className="text-gray-700">
              <strong>Code postal :</strong> {city.zipCode}<br />
          ...
          <div className="bg-gray-50 p-8 rounded-xl border border-gray-200">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-700">
                  Oui, {city.name} est dans notre zone d'intervention. Nous y réalisons régulièrement des chantiers de maçonnerie générale, rénovation et extension.
                </p>
              </div>
              <div className="border-t border-gray-200 pt-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Quel est le coût d'une intervention ?</h3>
                <p className="text-gray-700">
                  Le coût dépend de votre projet. Nous vous proposerons un devis détaillé et personnalisé lors d'une visite gratuite.
                </p>
              </div>
              <div className="border-t border-gray-200 pt-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Comment prendre contact ?</h3>
                <p className="text-gray-700">
                  Vous pouvez nous appeler au 06 88 14 42 57 ou remplir notre formulaire de contact. Nous vous répondons sous 24h.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom max-w-3xl">
          <div className="bg-white p-8 rounded-xl border-2 border-primary-200 shadow-lg">
            ...
            <p className="text-gray-700 mb-8">
              Contactez DZ Maçonnerie pour un devis gratuit. Notre équipe vous répondra sous 24h.
            </p>
