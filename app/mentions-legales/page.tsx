      ...
      <section className="section-padding bg-white">
        <div className="container mx-auto max-w-3xl prose prose-lg max-w-none">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-8 mb-4">
            1. Identification du responsable du site
          </h3>
          <p className="text-gray-700 mb-4">
            <strong>Nom du site :</strong> DZ Maçonnerie & Terrassement
            <br />
            <strong>Propriétaire :</strong> DZ Maçonnerie & Terrassement
            <br />
          ...
          <p className="text-gray-700 mb-4">
            Ce site est hébergé sur la plateforme Vercel Inc.
            <br />
          ...
          <p className="text-gray-700 mb-4">
            DZ Maçonnerie & Terrassement s'efforce d'assurer l'exactitude et la
            mise à jour des informations présentes sur ce site. Cependant, DZ
            Maçonnerie & Terrassement ne peut être tenu responsable des erreurs
            ou omissions, ainsi que de l'utilisation qui pourrait être faite des
          ...
          <p className="text-gray-700 mb-4">
            L'ensemble du contenu du site DZ Maçonnerie & Terrassement (textes,
            images, logos, etc.) est protégé par les droits d'auteur et les
            droits de propriété intellectuelle. Toute reproduction, distribution
            ou transmission du contenu sans autorisation écrite préalable est
            interdite.
          </p>
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4">
            <li>
              Les dommages directs ou indirects résultant de l'accès au site
            </li>
            <li>Les erreurs ou omissions du contenu</li>
            <li>
              Les virus ou codes malveillants qui pourraient être transmis
            </li>
          ...
          <p className="text-gray-700 mb-4">
            Le site peut contenir des liens vers d'autres sites web. DZ
            Maçonnerie & Terrassement ne contrôle pas le contenu de ces sites
          ...
          <p className="text-gray-700 mb-4">
            ...
            au RGPD, vous disposez d'un droit d'accès, de rectification et de
            suppression des données personnelles vous concernant. Pour exercer
            ces droits, veuillez nous contacter à : contact@dzmaconnerie38.fr
          </p>
          ...
          <p className="text-gray-700 mb-4">
            ...
            mentions légales à tout moment. Les modifications seront effectées
          ...
          <p className="text-gray-700">
            Ces mentions légales sont soumises à la loi française. Tout litige
            sera soumis aux juridictions compétentes de Isère.
          </p>
        </div>
      </section>
